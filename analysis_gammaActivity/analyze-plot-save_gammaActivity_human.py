...
save_loc_mat = 'C:/Users/vmysorea/Desktop/PhD/Stim_Analysis/Binding/Analyzed_FilesFigures_Human/Gamma_Matfiles/OtherChans/'
...
#%% Looking at gamma bands 
    ...
    mat_ids = dict(power12_all=a, power20_all=b,freqs=freqs, picks=picks, n_cycles=n_cycles, t=t)
    savemat(save_loc_mat + subj + '_OtherChans_gamma.mat', mat_ids)
    
    # del epochs_12, epochs_20, epochs12, epochs20, a, b, c, d, e, f, n_cycles, n_cycles1, n_cycles2
    
    del epochs_12, epochs_20, epochs12, epochs20, a, b, n_cycles
